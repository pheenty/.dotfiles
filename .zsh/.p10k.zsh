...
# Generated by Powerlevel10k configuration wizard on 2025-10-22 at 02:17 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    java_version                    # java version from jenv (https://github.com/jenv/jenv)
  ...
  ##################################[ context: user@hostname ]##################################
  # Context color in SSH.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=22
  # Context color when running locally.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{ROOT,REMOTE_SUDO}_TEMPLATE='%B%n:'
  # Context format when running without privileges: user@hostname:.
