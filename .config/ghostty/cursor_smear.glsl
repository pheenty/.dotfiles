// this is cursor_smear_fade.glsl taken at commit https://github.com/KroneCorylus/ghostty-shader-playground/commit/dd008a76ffe5dce93433c1ff962451a0dd36bc3a
...
const vec4 TRAIL_COLOR = vec4(0.369,0.945, 1.0, 1.0); // edited
